<?php
    ...
    include_once($_SERVER['DOCUMENT_ROOT'].'/include/menu-blog.php');
?> 
    <title>Blog - CSGA</title>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href="<?php echo dirname($urlpath)?>">Home</a></li>
          <li>Blog</li>
        </ol>
        <h2>Blog</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <?php
            ...
            $page=$_GET['page'];
            if ($page == '2'){ include_once('page#2.php');}
            else if ($page == '3'){ include_once('page#3.php');}
            else { include_once('page#1.php');} 
            ?>
