      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Language</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="<?php echo $path.'/vn/'.basename($urlpath).'?'.$_SERVER['QUERY_STRING']?>">🇻🇳 Việt Nam</a></li>
              <li><a href="<?php echo $path.'/en/'.basename($urlpath).'?'.$_SERVER['QUERY_STRING']?>">🇺🇸 English</a></li>
