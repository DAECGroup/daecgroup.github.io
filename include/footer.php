  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Email:</strong> admin@blackyukios.tk<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>CSGA</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="/">CSGA</a>
        </div>
      </div>
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        <a href="#" class="twitter"><i class="bx bxl-twitter"></i></a>
        <a href="https://www.facebook.com/groups/blackyukios" class="facebook"><i class="bx bxl-facebook"></i></a>
  ...
  <script src="<?php echo $path.'/assets/js/tawk.js';?>"></script>